...
function ImportPurchasesPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ImportPurchasesPage.useEffect": ()=>{
            const fetchWh = {
                "ImportPurchasesPage.useEffect.fetchWh": async ()=>{
                    ...
                    const data = [];
                    snap.forEach({
                        "ImportPurchasesPage.useEffect.fetchWh": (d)=>{
                            if (d.data().type === 'physical' || !d.data().type) data.push({
                                id: d.id,
                                ...d.data()
                            });
                        }
                    }["ImportPurchasesPage.useEffect.fetchWh"]);
                    setWarehouses(data);
                }
            }["ImportPurchasesPage.useEffect.fetchWh"];
            fetchWh();
    ...
    const handleFile = async (e)=>{
        ...
        try {
            ...
            reader.onload = async (ev)=>{
                const workbook = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["read"](ev.target.result, {
                    type: 'array'
                });
...
_s(ImportPurchasesPage, "qyMZTrEC6D0tAHRlvy34gz/Wiw8=", false, function() {
    return [
...
_c = ImportPurchasesPage;
var _c;
__turbopack_context__.k.register(_c, "ImportPurchasesPage");
...
//# sourceMappingURL=app_purchases-import_page_dd29df84.js.map