...
function VariantsPage() {
    ...
    const fetchData = async ()=>{
        try {
            ...
            const prodsData = [];
            snapProd.forEach((d)=>prodsData.push({
                    id: d.id,
                    ...d.data()
                }));
            setProducts(prodsData);
            const varsData = [];
            snapVar.forEach((d)=>varsData.push({
                    id: d.id,
                    ...d.data()
                }));
    ...
    const generateSku = ()=>{
        ...
        setFormData({
            ...formData,
            sku: newSku,
            barcode: formData.barcode || newSku
        });
    };
    ...
    }).sort(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sortBySize"]);
